...
class YsbSchoolsUkkConfig extends Model
{
    use HasFactory, KeyGenerate;

    protected $primaryKey   = 'id';

    protected $table = 'ysb_schools_ukk_configs';
    ...
    {
        return $this->hasOne(YsbPosition::class, 'position_code', 'ysb_position_id')->where('ysb_positions.state', true);
    }
}
