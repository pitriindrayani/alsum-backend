...
<head>
    ...
    <meta property="og:title" content="Verifikasi Gagal">
                                                            ...
                                                            <tbody>
                                                                <tr align="center">
                                                                    <td align="center" valign="middle"
                                                                        ...
                                                                        <img width="70"
                                                                            src="{{asset('images/gagal.png')}}"
                                                                            style="width:70px;max-width:70px;border:0;height:auto;line-height:100%;outline:none;text-decoration:none;">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                        ...
                                        <td valign="top" class="footerContent"
                                            ...
                                            <div
                                                ...
                                                <p style="text-align:left;margin:0;margin-top:2px;">SDC Apps | BSD,
                                                    Tangerang, 15339 | Copyright © 2022 | Kurnia Informatika Sistem |
