...
<head>
    ...
    <meta property="og:title" content="Verifikasi Berhasil">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="450" id="templateHeader"
                                    ...
                                    <tr>
                                        <td class="headerContent centeredWithBackground"
                                            style="border-collapse:collapse;color:#202020;font-family:Arial;font-size:34px;font-weight:bold;line-height:100%;padding:0;text-align:center;vertical-align:middle;background-color:#F4EEE2;padding-bottom:20px;padding-top:20px;">
                                                ...
                                                <tr>
                                                    <td valign="top"
                                                        ...
                                                        <div
                                                            ...
                                                            <h1 class="h1"
                                                                style="color:#202020;display:block;font-family:Arial;font-size:24px;font-weight:bold;line-height:100%;margin-top:20px;margin-right:0;margin-bottom:20px;margin-left:0;text-align:center;">
                                                            ...
                                                            <tbody>
                                                                <tr align="center">
                                                                    <td align="center" valign="middle"
                                                                        ...
                                                                        <img width="70" src="{{asset('images/sukses.png')}}" style="width:70px;max-width:70px;border:0;height:auto;line-height:100%;outline:none;text-decoration:none;">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <td valign="top" width="100%" style="border-collapse:collapse;">
                                                        ...
                                                        <div style="text-align: center; color: #c9c9c9;">
                                                            <p>Questions? Get your answers here:&nbsp;
                                                                <a href="http://help.atavist.com"
                                                                    style="color:#4a90e2;font-weight:normal;text-decoration:underline; font-size: 12px;">Help
                                                                    Center</a>.
                                                            </p>
                                                        </div>
                                                        <br>
                                    ...
                                    <tr>
                                        <td valign="top" class="footerContent"
                                            ...
                                            <div
                                                ...
                                                <p style="text-align:left;margin:0;margin-top:2px;">SDC Apps | BSD,
                                                    Tangerang, 15339 | Copyright © 2022 | Kurnia Informatika Sistem | All rights reserved</p>
                                            </div>
                                            <!-- // End Module: Standard Footer \\ -->
                                        </td>
                                    </tr>
